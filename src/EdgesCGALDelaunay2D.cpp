...
int main(int argc, char** argv){
  if(argc!=3){
    std::fprintf(stderr, "Usage: %s points.npy out_edges.npy\n", argv[0]);
    return 64;
  }
  std::vector<int64_t> shpP;
  ...
  using Vb = CGAL::Triangulation_vertex_base_with_info_2<uint64_t, K>;
